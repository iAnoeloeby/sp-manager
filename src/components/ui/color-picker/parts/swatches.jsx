...
export const Swatches = React.forwardRef(function Swatches(
    { presets = DEFAULT_PRESETS, onAdd, className, ...rest },
    ref,
) {
    // P6: subscribe to color + setColor only. No re-render on format toggles
    ...
    return (
        ...
        >
            ...
            {onAdd && (
                ...
                >
                    <PlusCircleIcon weight="bold" className="size-3" />
                </button>
            )}
        </div>
    );
