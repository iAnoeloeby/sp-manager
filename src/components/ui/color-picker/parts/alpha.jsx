...
import { useColorStateSlice, useActions } from "../context";
...
export const Alpha = React.forwardRef(function Alpha(
    { orientation = "horizontal", className, ...rest },
    ref,
) {
    // P6: subscribe to color + setComponent only.
    const color = useColorStateSlice((s) => s.color);
    const setComponent = useActions().setComponent;
            ...
            <div
                ...
                style={
                    isVertical
                        ? {
                              left: "50%",
                              top: `calc(${color.alpha} * (100% - 16px) + 8px)`,
                              background: opaque,
                          }
                        : {
