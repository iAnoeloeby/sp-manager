...
import { findMaxChroma, gamutFromFormat, hslHue, hsbHue } from "../lib/color";
import { setColorChannel } from "../lib/channels";
import { cn } from "@/lib/utils";

export const Hue = React.forwardRef(function Hue(
    { orientation = "horizontal", className, ...rest },
    ref,
) {
    // P6: subscribe to color + format only. No re-render on background or
    // setFormat changes (FormatSwitcher toggle doesn't repaint the hue strip).
